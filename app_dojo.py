...
# Wrap the entire application in an interceptor to prevent "Oh no" crashes
try:
    # ---- CONFIGURATION ----
    st.set_page_config(
    ...
    with tab_add:
        ...
        # Display success messages securely across page reloads
    ...
    st.error("🚨 CRASH INTERCEPTED 🚨")
    st.warning("The app encountered an error but was prevented from crashing. Please copy the red text below.")
